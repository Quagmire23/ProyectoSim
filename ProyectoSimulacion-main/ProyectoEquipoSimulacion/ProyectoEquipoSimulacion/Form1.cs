...
namespace ProyectoEquipoSimulacion
{
    public partial class Form1 : Form
    {
        ...
        private void PruebaFrecuencia_Click(object sender, EventArgs e)
        {
            
            P_Distancia p1 = new P_Distancia();

            p1.tbA2.Text = tbA.Text;
            p1.tbC2.Text = tbC.Text;
            p1.tbM2.Text = tbM.Text;
            p1.tbXo2.Text = tbXo.Text;
            p1.tbn2.Text = tbn.Text;
            p1.nn.Text = tbn.Text;
            p1.Show();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //mandar los valores a la prueva de distancia
